...
th_dim_model = mnist_network.build_model() # Create your theano model here with TH dim ordering

K.set_image_dim_ordering('tf')
tf_dim_model = utils.cnn_model() # Create your tensorflow model with TF dimordering here

#model_weights = ['mnist.h5']
model_weights = ['mnist_retrained_pixelSets_5526_20_L1_0.03.h5'] # Add names of theano model weight file paths here.
